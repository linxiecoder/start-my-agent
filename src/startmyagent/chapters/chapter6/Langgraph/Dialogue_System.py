...
class SearchState(TypedDict):
    ...
    search_query: str  # 优化后用于调用Tavily API的搜索查询
...
def create_search_assistant():
    ...
    workflow.add_node("searched",tavily_search_node)
    workflow.add_node("answer",generate_answer_node)

    workflow.add_edge(START,"understand")
    workflow.add_edge("understand","searched")
    workflow.add_edge("searched","answer")
